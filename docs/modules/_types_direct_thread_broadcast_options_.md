...
*Defined in [types/direct-thread.broadcast.options.ts:18](https://github.com/cuonglnhust/instagram-private-api-tcom/blob/3e16058/src/types/direct-thread.broadcast.options.ts#L18)*